...
/* STARTUP CODE MODIFIED BY @Ware Systems (c) 2009*/
...
#pragma code _entry_scn=0x002000
void
_entry (void)
{
...
_startup (void)
{
  _sp1=FSR1;
  _sp2=FSR2;
  //@Ware Systems already initialized the stack pointer
  _asm
...
//loop:
  ...
  //goto loop;
  //Retornar al ejecutivo y restaurar la pila
  FSR1=_sp1;
  FSR2=_sp2;
}                               /* end _startup() */
